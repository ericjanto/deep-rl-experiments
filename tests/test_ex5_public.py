...
def test_imports():
    from experiments.experiment4 import DDPG
    from experiments.experiment5.train_ddpg import RACETRACK_CONFIG as CONFIG

def test_config():
    from experiments.experiment5.train_ddpg import RACETRACK_CONFIG
...
def test_restore_file():
    ...
    save_dir = os.path.join(save_dir, 'rl2024/experiment5')
