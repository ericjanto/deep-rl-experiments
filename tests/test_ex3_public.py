...
def test_imports_0():
    from experiments.experiment3 import DQN, Reinforce, ReplayBuffer
    from experiments.experiment3.train_dqn import MOUNTAINCAR_CONFIG as DQN_MOUNTAINCAR_CONFIG
    from experiments.experiment3.train_reinforce import CARTPOLE_CONFIG as REINF_CARTPOLE_CONFIG

def test_config_0():
    from experiments.experiment3.train_dqn import MOUNTAINCAR_CONFIG
...
def test_config_1():
    from experiments.experiment3.train_reinforce import CARTPOLE_CONFIG
