...
from experiments.constants import EX4_RACETRACK_CONSTANTS as RACETRACK_CONSTANTS
from experiments.experiment4.agents import DDPG
from experiments.experiment3.replay import ReplayBuffer
from experiments.util.hparam_sweeping import generate_hparam_configs
from experiments.util.result_processing import Run
...
RACETRACK_HPARAMS = {
    "critic_hidden_size": [[32, 32, 32], [64, 64, 64], [128, 128, 128]],
    "policy_hidden_size": [[32, 32, 32], [64, 64, 64], [128, 128, 128]],
    }

SWEEP_RESULTS_FILE_RACETRACK = f"DDPG-Racetrack-sweep-results-ex4-critic-hs-{RACETRACK_CONFIG['critic_hidden_size']}-policy-hs-{RACETRACK_CONFIG['policy_hidden_size']}.pkl"
