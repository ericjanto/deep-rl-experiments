...
class MDP:
    ...
    def _get_state_label(self, state_index) -> str:
        """Returns the label of a state given its index

        :param state_index (int): index of the state
        :return (str): label of the state
        """
        for state, index in self._state_dict.items():
            if index == state_index:
                return state
    
    def _get_action_label(self, action_index) -> str:
        """Returns the label of an action given its index

        :param action_index (int): index of the action
        :return (str): label of the action
        """
        for action, index in self._action_dict.items():
