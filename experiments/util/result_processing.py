...
if __name__ == "__main__":
    # Specify the path to your results.pkl file
    results_file = '../experiment3/DQN-MountainCar-sweep-decay-linear-results.pkl'

    # Load the list of Run objects from the file
    ...
    for i, run in enumerate(ranked_runs):
        print(f"Rank {i+1}: {run.run_name}, Final Return Mean: {run.final_return_mean}, std err: {run.final_return_ste}")